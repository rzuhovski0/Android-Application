...
public class ReservationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Get the barberShop from intent
        this.barberShop = (User) getIntent().getSerializableExtra("user");
        this.barberShopId = barberShop.getId();

        // Init objects for static methods
...
//                reservations = barberShop.getReservations();
    ...
    private void setContactInfoAboutUsListeners()
    {
        AboutUsTextView.setOnClickListener(view -> {
            Intent intent = new Intent(ReservationActivity.this,AboutUsActivity.class);
            startActivity(intent);
            /*Without finish() to not close current Activity*/
        });

        ContactInfoTextView.setOnClickListener(view -> {
            Intent intent = new Intent(ReservationActivity.this,ContactInfoActivity.class);
...
//
    ...
    /**Just a testing method -> delete later, use real info*/
