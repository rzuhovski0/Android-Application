...
public class OthersAdapter extends RecyclerView.Adapter<OthersAdapter.ViewHolder> {
    ...
    public OthersAdapter(List<User> users, Context mContext) {
    ...
    public OthersAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view;
        view = LayoutInflater.from(parent.getContext()).inflate(R.layout.shop_other_display, parent, false);
        return new OthersAdapter.ViewHolder(view);
    }
